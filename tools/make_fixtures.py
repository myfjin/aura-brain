...
MOVES = [
    (
        "synthetic-verify-before-claiming",
        "the agent is about to report a result",
    ...
    (
        "synthetic-revert-to-prove",
        "a fix is reported as working",
    ...
    (
        "synthetic-tombstone-not-delete",
        "a row or file is to be removed",
    ...
    (
        "synthetic-measure-the-null",
        "a success rate is quoted",
    ...
    (
        "synthetic-name-the-confound",
        "a comparison favours one option",
    ...
    (
        "synthetic-fail-once-first",
        "a checker is about to be trusted",
    ...
    (
        "synthetic-read-newest-state",
        "a status is recalled from memory",
    ...
    (
        "synthetic-one-concern-per-change",
        "a change fixes two things",
    ...
    (
        "synthetic-push-back-with-evidence",
        "a correction is due to a peer",
    ...
    (
        "synthetic-say-it-out-loud",
        "advice was received and quietly used",
    ...
    (
        "synthetic-interface-before-implementation",
        "a subsystem is handed over",
    ...
    (
        "synthetic-cost-is-not-a-measurement",
        "a cost is reported from memory",
...
def main() -> int:
    ...
    con.execute(
        "CREATE TABLE messages (id TEXT, session_id TEXT, role TEXT, content TEXT, timestamp TEXT)"
    )
    lines = [
